...
/*   Updated: 2017/11/26 00:10:11 by lbelda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_kfuncs_model(t_controls *controls)
{
	...
	(controls->modelmode)[1] = (t_kfuncs) { k_trsx, K_LEFT };
	(controls->modelmode)[2] = (t_kfuncs) { k_trsx, K_RIGHT };
	(controls->modelmode)[3] = (t_kfuncs) { k_trsx, K_UP };
	(controls->modelmode)[4] = (t_kfuncs) { k_trsx, K_DOWN };
	(controls->modelmode)[5] = (t_kfuncs) { k_rotx, K_W };
	(controls->modelmode)[6] = (t_kfuncs) { k_exit, K_S };
...
static void	set_kfuncs_camera(t_controls *controls)
{
	...
	(controls->cammode)[1] = (t_kfuncs) { k_rotcamry, K_LEFT };
	(controls->cammode)[2] = (t_kfuncs) { k_rotcamy, K_RIGHT };
