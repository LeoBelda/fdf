...
/*   Updated: 2017/12/18 03:41:47 by lbelda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	dw_pt((t_vec2r){pt.x, pt.y - 7}, (t_cmix){cl.st2, cl.bg1, .8}, ad);
	dw_pt((t_vec2r){pt.x, pt.y - 6}, (t_cmix){cl.st2, cl.bg1, .7}, ad);
	dw_pt((t_vec2r){pt.x, pt.y - 5}, (t_cmix){cl.st2, cl.bg1, .6}, ad);
...
{
	dw_pt((t_vec2r){pt.x - 4, pt.y}, (t_cmix){cl.st2, cl.bg1, .8}, ad);
